module.exports = grammar({
  ...
  rules: {
    ...
    function_parameter: ($) =>
      seq(field("name", $.identifier_lower), ":", field("type", $._type)),
    ...
    equal_statement: ($) =>
      seq(field("name", $.identifier_lower), "=", field("value", $.expression)),

    return_statement: ($) =>
      choice("return", seq("return", field("value", $.expression))),

    break_statement: ($) =>
      choice("break", seq("break", field("value", $.expression))),

    expression_statement: ($) => choice($.expression, seq($.expression, ";")),
    ...
    literal: ($) => choice($.number, $.string, $.unit),
    ...
    function_call: ($) =>
      choice(
        ...
        seq(field("function", $.identifier_lower), "(", ")")
      ),
    ...
    match_case: ($) =>
      seq(field("pattern", $.match_pattern), "=>", field("body", $.expression)),
    ...
    tuple_pattern: ($) => seq("(", commaSep($.pattern_element), ")"),

    pattern_element: ($) =>
      choice($.identifier_lower, $.identifier_upper, $.wildcard),
    ...
    handler_expression: ($) =>
      seq("hn", "{", field("cases", repeat($.handler_case)), "}"),
